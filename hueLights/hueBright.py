...
# Configuration
TRAINING_MODE = False # Set to True to enable training EMG mode; set to False for control mode
BRIDGE_IP = '192.168.1.89' # Replace with your Hue Bridge IP (Found in the settings of Hue app)
